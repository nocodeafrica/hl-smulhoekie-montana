...
export default function DailyMealsPage() {
  ...
  return (
    <main ref={containerRef} className="bg-[#FFFDFB] min-h-screen overflow-hidden pt-20 lg:pt-28">
      
      {/* Breadcrumbs */}
      <div className="bg-[#FFFDFB] pt-4 pb-4 border-b border-orange-100">
      ...
      {/* 4. CTA Section */}
      <section className="py-24 relative cta-section overflow-hidden">
        {/* Background Image with Overlay */}
        <div className="absolute inset-0 z-0">
          <Image 
            src="https://images.unsplash.com/photo-1670931356795-82263eac887b?w=1200&auto=format&fit=crop&q=80"
